 ...
 */ 
public class EURUSD extends Thread implements SwsListener {
...
private static String value="";
	...
	public void run() {
		...
		reqID_EURUSD = m_api.monitorPrice(symbol);
	...
	public void swsPriceUpdated(MonitorPriceResponse resObject) {
		...
		if(!eusTimeStamp.equals(strTimeStamp))
		{
			setValue(last);
			eusTimeStamp=strTimeStamp;
				try {
